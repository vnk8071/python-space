...
logger.info(f"UserStaticMethod: {UserStaticMethod.fullname_static_function('Khoi', 'VN')}")
# UserStaticMethod: Khoi VN

assert UserStaticMethod.fullname_static_method('Khoi', 'VN') == 'Khoi VN'
logger.info(f"UserStaticMethod: {UserStaticMethod.fullname_static_method('Khoi', 'VN')}")
# UserStaticMethod: Khoi VN

try:
    user_static_method = UserStaticMethod()
    logger.info(f"UserStaticMethod: {user_static_method.fullname_static_method('Khoi', 'VN')}")
    # UserStaticMethod: Khoi VN
    logger.info(f"UserStaticMethod: {user_static_method.fullname_static_function('Khoi', 'VN')}")
...
logger.info(f"UserDynamicMethod: {user_class_method.fullname_dynamic_method('Khoi', 'VN')}")
# UserDynamicMethod: Khoi VN

try:
    assert user_class_method.fullname_without_class_method('Khoi', 'VN') == 'Khoi VN'
    logger.info(f"UserClassMethod: {UserClassMethod.fullname_without_class_method('Khoi', 'VN')}")
...
try:
    ...
    logger.info(f"UserDynamicMethod: {UserClassMethod.fullname_dynamic_method('Khoi', 'VN')}")
