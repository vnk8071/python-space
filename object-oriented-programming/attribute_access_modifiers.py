...
logger.info(f"UserPrivateAttribute: {__khoivn._UserPrivateAttribute__firstname} \
{__khoivn._UserPrivateAttribute__lastname}")  # Khoi VN
...
assert get_protected_attributes(khoivn) == {
    '_age': 23,
...
assert get_private_attributes(khoivn) == {
